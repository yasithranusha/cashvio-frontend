...
export const columns: ColumnDef<TSupplier>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const haveWhatsApp = row.original.haveWhatsApp;

      // Format phone number for links (remove any + sign)
      const formattedNumber = contact.replace("+", "");
      ...
      return (
        <div className="text-left flex items-center gap-2">
          ...
          {haveWhatsApp && (
            <Link
              href={`https://api.whatsapp.com/send/?phone=${formattedNumber}&text&type=phone_number`}
              target="_blank"
